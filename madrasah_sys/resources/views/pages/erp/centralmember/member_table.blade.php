                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
								...
								<button type="button" value="{{$member->id}}" class="btn btn-warning" id="editmember" ><i class="bi bi-pencil-square"></i>  Edit</button>

								
								 
								  <a class="btn btn-primary" href="#" value="{{$member->id}}" class="dropdown-item" id="deletebtnt"><i class="bi bi-trash-fill"></i> </a>
