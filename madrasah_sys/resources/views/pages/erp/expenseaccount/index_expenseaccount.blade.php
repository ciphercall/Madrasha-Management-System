...
<div class="content container-fluid">
	...
	<div class="page-header">
		<div class="row align-items-center">
			<div class="col">
				<h3 class="page-title">Expense Account  </h3>
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
					<li class="breadcrumb-item active">Expense Account  </li>
				</ul>
			</div>
			<div class="col-auto float-right ml-auto">
				<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_overtime"><i class="fa fa-plus"></i> Add Expense Account </a>
			</div>
		</div>
	</div>
	<!-- /Page Header -->
		...
		<div class="col-md-12">
			<div class="table-responsive">
				<table class="table table-striped custom-table mb-0 datatable">
					...
					<tbody>
						@forelse ($expenseaccounts as $expenseaccount)




						<tr>
							<td>{{$expenseaccount->brunch_name}}</td>
			...
			<div class="modal-body" style="background-color: rgb(4, 21, 34)">
				...
				<form action="">
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="col-form-label" id="labelb">Amount_money : <span class="text-danger">*</span></label>
