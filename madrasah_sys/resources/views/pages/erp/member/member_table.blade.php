                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
								...
								<button type="button" value="{{$member->id}}" class="btn btn-warning" id="editmember" ><i class="bi bi-pencil-square"></i>  </button>

								
								 
								  <a class="btn btn-primary" href="#" value="{{$member->id}}" class="dropdown-item" id="deletebtn"><i class="bi bi-trash-fill"></i> </a>
...
<script>
	$(document).ready(function () {
		...
		// 	var tmember_id=$(this).val();
        //     alert(tmember_id);
		// 	// $('#deletemembert').modal('show');
		// 	// $('#delete_memberIdt').val(tmember_id);
		// });
