...
<div class="content container-fluid">
	...
	<div class="page-header">
		<div class="row align-items-center">
			<div class="col">
				<h3 class="page-title">Qurankhatam </h3>
				<ul class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
					<li class="breadcrumb-item active">Qurankhatam </li>
				</ul>
			</div>
			<div class="col-auto float-right ml-auto">
				<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_overtime"><i class="fa fa-plus"></i> Add Qurankhatam</a>
			</div>
		</div>
	</div>
	<!-- /Page Header -->
	...
	<div class="row">
		<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
			<div class="stats-info">
				<h6>Qurankhatam Center member</h6>
				<h4>12 <span>this month</span></h4>
			</div>
		</div>
		<div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
			<div class="stats-info">
				<h6>Qurankhatam Center Hours</h6>
		...
		<div class="col-md-12">
			<div class="table-responsive">
				<table class="table table-striped custom-table mb-0 datatable">
					...
					<tbody>
						@forelse ($qurankhatams as $qurankhatam)
	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Add Qurankhatams </h5>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="number" class="form-control" id="" name="txtStudid" placeholder="Enter " required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="email" class="form-control" id="" name="txtEmail" placeholder="Enter " >
							</div>
				...
				<form action="{{url('qurankhatam-update')}}"  method="POST" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label class="col-form-label">Studid  : <span class="text-danger">*</span></label>
								<input type="number" class="form-control" id="qubrunch_name" name="txtStudid" placeholder="Enter " required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label class="col-form-label">Occasion : <span class="text-danger">*</span></label>
								<input type="text" class="form-control" id="quoccasion" name="txtOccasion" placeholder="Enter " >
							</div>
						</div>		
						<div class="col-sm-6">
			...
			<div class="modal-body" style="background-color: rgb(4, 21, 34)">
				...
				<form action="">
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label class="col-form-label" id="labelb">E-mail : <span class="text-danger">*</span></label>
		...
		$(document).on('click','#quBtn',function(){
			...
			$.ajax({
				...
				success:function(response){
					...
					$('#qubrunch_name').val(response.qurankhatam.studid);
